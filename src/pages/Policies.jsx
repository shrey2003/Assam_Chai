      ...
      <main className="policies-main-content">
        ...
        <section className="return-policy">
          ...
          <p>
            ...
            shipping costs are not covered by Assam Chai.
          </p>
        </section>
        ...
        <section className="terms-conditions">
          ...
          <p>
            By accessing or using the Assam Chai website and our services, you
        ...
        <section className="sustainability-commitment">
          ...
          <p>
            Sustainability is at the heart of everything we do at Assam Chai.
